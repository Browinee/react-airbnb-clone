...
import {GlobeAltIcon, UserIcon, MenuIcon, SearchIcon, UserCircleIcon} from "@heroicons/react/solid";
                ...
                search && (
                    <div className={"col-span-3 mx-auto flex flex-col mt-5"}>
                        ...
                        <div className={"flex items-center border-b mb-4"}>
                            ...
                            <input min={1} type="number" value={numberOfGuests} onChange={numberOfGuestsHandler} className={"w-12 pl-2 text-lg outline-none text-red-400"} />
                        </div>
                        <div className={"flex"}>
